...
const PopUpForm = ({ type, onClose}) => {
    ...
    const handleOutsideClick = (e) => {
        // Si el clic ocurre fuera del contenido del popup, cierra el modal
    ...
    return (
    <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50" onClick={handleOutsideClick}>
        <div className='relative bg-white justify-start flex flex-col w-[700px] h-[281px]' onClick={(e) => e.stopPropagation()}>  
                ...
                <button onClick={onClose} className="w-[315px] border-b border-[#4C4C4C] outline-none self-end pb-2 cursor-pointer right-0 text-right pr-10">Skip</button>     
        </div>
    </div>
    )
};
